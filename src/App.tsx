          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h3 className="text-4xl md:text-5xl font-serif font-bold mb-8 leading-tight">
                ...
                惠州市美创门业有限公司坐落仲恺潼侨，是惠州仲恺本土实体门类生产工厂，主营入户安全门、全屋实木烤漆门、铝木复合门、极窄铝合金极简门四大品类。工厂全套数控裁切、封边、组装设备，每款产品出厂经过隔音、密封、防潮、抗压多重质检，解决广东珠三角地区木门开裂、铝门渗水、入户门防盗差等家装痛点。经营模式为工厂直营零售+工程批量供货+经销商加盟三重渠道，不经过中间商，同等配置低于门店零售价30%左右。自有安装团队，无需外包，售后响应24小时内上门。展厅地址：惠州市仲恺高新区潼侨镇新城山庄A8号铂金实业。
              </p>
